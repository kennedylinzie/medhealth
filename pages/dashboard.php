  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Med health</span>
      </a>
    </div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <button type="button" class="btn btn-primary" id="goto_admin">
            <span id="adm_name"></span>
            <span class="badge badge-md badge-circle badge-floating badge-danger border-white">Admin</span>
          </button>

          <script>
                document.getElementById("adm_name").innerHTML = getCookie("full_name");

                $(document).ready(function() {
                 $('#goto_admin').on('click', function() {
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-success btn-sm mb-0 me-3" onclick="logout()" >Logout</a>
            </li>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Scheme members</p>
                    <h5 id="Scheme_members" class="font-weight-bolder mb-0">
                    ...
                    <script>
                      //pulls...................................................................................,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
                            $(document).ready(function() {
                                  ...
                                  $.ajax({
                                            url: "http://localhost/MR/v2/Api_ad.php?apicall=pullmembers",
                                            type: "POST",
                                            data: {
                                            ...
                                            success: function(dataResult){
                                              ...
                                              document.getElementById("Scheme_members").innerHTML = dataResult1;                         
                                            }
                                          });
                              });
                    </script>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Reminder users</p>
                    <h5 id="Reminder_users" class="font-weight-bolder mb-0">
                    ...
                    <script>
                      //pulls...................................................................................,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
                            $(document).ready(function() {
                                  ...
                                  $.ajax({
                                            url: "http://localhost/MR/v2/Api_ad.php?apicall=pull_reminder_users",
                                            type: "POST",
                                            data: {
                                            ...
                                            success: function(dataResult){
                                              var dataResult1 = JSON.parse(dataResult);
                                              document.getElementById("Reminder_users").innerHTML = dataResult1;                         
                                            }
                                          });
                              });
                    </script>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Unverified Users </p>
                    <h5 id="Unverified_Users" class="font-weight-bolder mb-0">
                    ...
                    <script>
                      //pulls...................................................................................,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
                            $(document).ready(function() {
                                  ...
                                  $.ajax({
                                            url: "http://localhost/MR/v2/Api_ad.php?apicall=pull_unverified_users",
                                            type: "POST",
                                            data: {
                                            ...
                                            success: function(dataResult){
                                              var dataResult1 = JSON.parse(dataResult);
                                              document.getElementById("Unverified_Users").innerHTML = dataResult1;                         
                                            }
                                          });
                              });
                    </script>
      ...
      <div class="row mt-4">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold">Reminder App Users</p>
                    <h5 class="font-weight-bolder">The app for everyone.</h5>
                    <p class="mb-5">The app is for people who want to remove the madication hustle and live their lives.</p>
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="tables.html">
                      Read More
                ...
                <!-- BUilt for developers ends here-->
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div class="bg-gradient-white border-radius-lg h-0">
                    <img src="../assets/img/shapes/waves-white.svg" class="position-absolute h-0 w-50 top-50 d-lg-block d-none" alt="waves">
                    <div class="position-relative d-flex align-items-center justify-content-center h-0">
                      <img class="w-50 position-relative z-index-2 pt-4" src="../assets/img/illustrations/the_app.png" alt="rocket">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-5">
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/meds.jpg');">
              <span class="mask bg-gradient-dark"></span>
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">View user's medication information</h5>
                <p class="text-white">This shows the drugs the patients are taking  .</p>
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card z-index-2">
            <div class="card-body p-3">
              ...
              <h6 class="ms-2 mt-4 mb-0"> Reminders users </h6>
...
?>
    <style>
        ...
        #map { position:absolute;right: 0px; top:100px; bottom:0px;height:400%; width:100%; }
        .geocoder {
            position:absolute;left: 150%; top:20%; 
        }
    </style>
    ...
    <script>
        ...
        var user_location = [33.78725,-13.96692];
        mapboxgl.accessToken = 'pk.eyJ1Ijoia2VubmVkeWxpbnppZSIsImEiOiJja3pibHdnZnoxNDI1Mm9vMXZ2ZHl5cnh4In0.qBADFxvDhY8x3aFYTt8NKw';
        ...
        //document.getElementById('geocoder').appendChild(geocoder.onAdd(map));
          ...
          <!-- line chart for the emergencies made -->
          <div class="col-lg-7">
          <div class="card z-index-2">
